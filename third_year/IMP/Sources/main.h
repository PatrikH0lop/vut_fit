...
// polynomial - seed - tot - totr - fxor
int configurations[6][5] = {
		{0x04C11DB7, 0xFFFFFFFF, 0, 0, 1}, // CRC-32/BZIP2
		{0x04C11DB7, 0xFFFFFFFF, 0, 0, 0}, // CRC-32 MPEG-2
		{0x04C11DB7, 0x00000000, 0, 0, 1}, // CRC-32 POSIX
		{0xC867,     0xFFFF,     0, 0, 0}, // CRC16 - CDMA2000 : mobile networks
		{0x1021,     0xFFFF,     0, 0, 0}, // CRC-16/CCITT-FALSE 0xFFFF
		{0x04C11DB7, 0xFFFFFFFF, 1, 2, 1}  // CRC-32
};
